...
//                         <Link
//                             href="/add-pet"
//                             className="flex items-center gap-2 px-6 py-3 border border-gray-300 dark:border-gray-600 dark:text-white rounded-xl font-semibold hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
//                         >
...
//                         <div className="absolute -top-6 -left-8 z-10 bg-white dark:bg-gray-800 shadow-xl rounded-2xl px-4 py-3 flex gap-3 items-center">
//                             <Image
//                                 src="/dog.jpeg"
//                                 alt="Max"
//                                 width={40}
...
//                                 width={400}
//                                 height={450}
//                                 className="rounded-3xl object-cover shadow-2xl w-full h-full animate-float"
//                             />
//                         </div>

//                         {/* Bottom-right floating card */}
//                         <div className="absolute -bottom-6 -right-8 z-10 bg-white dark:bg-gray-800 shadow-xl rounded-2xl px-4 py-3 flex gap-3 items-center">
//                             <Image
//                                 src="/dog.jpeg"
//                                 alt="Luna"
//                                 width={40}
